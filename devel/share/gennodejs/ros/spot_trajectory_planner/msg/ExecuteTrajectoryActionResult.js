...
class ExecuteTrajectoryActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ExecuteTrajectoryResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ExecuteTrajectoryActionResult(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [status]
    data.status = actionlib_msgs.msg.GoalStatus.deserialize(buffer, bufferOffset);
    // Deserialize message field [result]
    data.result = ExecuteTrajectoryResult.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ExecuteTrajectoryActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = ExecuteTrajectoryResult.Resolve(msg.result)
    }
    else {
      resolved.result = new ExecuteTrajectoryResult()
    }
...
module.exports = ExecuteTrajectoryActionResult;
