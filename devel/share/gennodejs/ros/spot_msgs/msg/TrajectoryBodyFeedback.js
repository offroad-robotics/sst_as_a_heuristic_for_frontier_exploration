...
class TrajectoryBodyFeedback {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TrajectoryBodyFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new TrajectoryBodyFeedback(null);
...
module.exports = TrajectoryBodyFeedback;
