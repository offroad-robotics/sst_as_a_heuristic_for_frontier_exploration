...
class TrajectoryActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TrajectoryFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TrajectoryActionFeedback(null);
    ...
    data.feedback = TrajectoryFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += TrajectoryFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TrajectoryActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = TrajectoryFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new TrajectoryFeedback()
    }
...
module.exports = TrajectoryActionFeedback;
