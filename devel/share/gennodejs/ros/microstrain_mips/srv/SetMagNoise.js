...
class SetMagNoiseRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetMagNoiseRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetMagNoiseRequest
    let len;
    let data = new SetMagNoiseRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetMagNoiseRequest(null);
...
class SetMagNoiseResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetMagNoiseResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetMagNoiseResponse
    let len;
    let data = new SetMagNoiseResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'microstrain_mips/SetMagNoiseResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetMagNoiseResponse(null);
...
module.exports = {
  Request: SetMagNoiseRequest,
  Response: SetMagNoiseResponse,
  md5sum() { return '6a73c0e939ba0cee17d40a2e3a5f667f'; },
  datatype() { return 'microstrain_mips/SetMagNoise'; }
};
