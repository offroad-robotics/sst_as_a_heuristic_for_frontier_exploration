...
class SetGyroBiasModelRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetGyroBiasModelRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetGyroBiasModelRequest
    let len;
    let data = new SetGyroBiasModelRequest(null);
  ...
  static datatype() {
    ...
    return 'microstrain_mips/SetGyroBiasModelRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetGyroBiasModelRequest(null);
...
class SetGyroBiasModelResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.success = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetGyroBiasModelResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetGyroBiasModelResponse
    let len;
    let data = new SetGyroBiasModelResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'microstrain_mips/SetGyroBiasModelResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetGyroBiasModelResponse(null);
...
module.exports = {
  Request: SetGyroBiasModelRequest,
  Response: SetGyroBiasModelResponse,
  md5sum() { return 'f3cdd18c97add875be98974ab1d992b9'; },
  datatype() { return 'microstrain_mips/SetGyroBiasModel'; }
};
