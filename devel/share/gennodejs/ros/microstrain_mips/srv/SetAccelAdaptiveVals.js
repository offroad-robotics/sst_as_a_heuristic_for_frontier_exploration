...
class SetAccelAdaptiveValsRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetAccelAdaptiveValsRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetAccelAdaptiveValsRequest
    let len;
    let data = new SetAccelAdaptiveValsRequest(null);
  ...
  static datatype() {
    ...
    return 'microstrain_mips/SetAccelAdaptiveValsRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetAccelAdaptiveValsRequest(null);
...
class SetAccelAdaptiveValsResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.success = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetAccelAdaptiveValsResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetAccelAdaptiveValsResponse
    let len;
    let data = new SetAccelAdaptiveValsResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'microstrain_mips/SetAccelAdaptiveValsResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetAccelAdaptiveValsResponse(null);
...
module.exports = {
  Request: SetAccelAdaptiveValsRequest,
  Response: SetAccelAdaptiveValsResponse,
  md5sum() { return 'f4333508f865a0d6b01f8e48e0168654'; },
  datatype() { return 'microstrain_mips/SetAccelAdaptiveVals'; }
};
