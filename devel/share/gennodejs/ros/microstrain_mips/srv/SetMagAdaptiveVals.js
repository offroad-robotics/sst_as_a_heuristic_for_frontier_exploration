...
class SetMagAdaptiveValsRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetMagAdaptiveValsRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetMagAdaptiveValsRequest
    let len;
    let data = new SetMagAdaptiveValsRequest(null);
  ...
  static datatype() {
    ...
    return 'microstrain_mips/SetMagAdaptiveValsRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetMagAdaptiveValsRequest(null);
...
class SetMagAdaptiveValsResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.success = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetMagAdaptiveValsResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetMagAdaptiveValsResponse
    let len;
    let data = new SetMagAdaptiveValsResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'microstrain_mips/SetMagAdaptiveValsResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetMagAdaptiveValsResponse(null);
...
module.exports = {
  Request: SetMagAdaptiveValsRequest,
  Response: SetMagAdaptiveValsResponse,
  md5sum() { return 'f4333508f865a0d6b01f8e48e0168654'; },
  datatype() { return 'microstrain_mips/SetMagAdaptiveVals'; }
};
