...
if("TRUE" STREQUAL "TRUE")
  set(octomap_server_SOURCE_PREFIX /home/spot/frontier_exploration_ssl_spot/src/octomap_server)
  set(octomap_server_DEVEL_PREFIX /home/spot/frontier_exploration_ssl_spot/devel)
  ...
  set(octomap_server_INSTALL_PREFIX /home/spot/frontier_exploration_ssl_spot/install)
...
if(NOT "/home/spot/frontier_exploration_ssl_spot/devel/include;/home/spot/frontier_exploration_ssl_spot/src/octomap_server/include;/usr/local/include " STREQUAL " ")
  set(octomap_server_INCLUDE_DIRS "")
  set(_include_dirs "/home/spot/frontier_exploration_ssl_spot/devel/include;/home/spot/frontier_exploration_ssl_spot/src/octomap_server/include;/usr/local/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'octomap_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/spot/frontier_exploration_ssl_spot/src/octomap_server/${idir}'.  ${_report}")
    endif()
    _list_append_unique(octomap_server_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "octomap_server;/usr/local/lib/liboctomap.so;/usr/local/lib/liboctomath.so")
