...
(cl:defmethod cl:initialize-instance :after ((m <SetSoftIronMatrix-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetSoftIronMatrix-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name microstrain_mips-srv:<SetSoftIronMatrix-request> is deprecated: use microstrain_mips-srv:SetSoftIronMatrix-request instead.")))

(cl:ensure-generic-function 'soft_iron_1-val :lambda-list '(m))
(cl:defmethod soft_iron_1-val ((m <SetSoftIronMatrix-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader microstrain_mips-srv:soft_iron_1-val is deprecated.  Use microstrain_mips-srv:soft_iron_1 instead.")
  (soft_iron_1 m))

(cl:ensure-generic-function 'soft_iron_2-val :lambda-list '(m))
(cl:defmethod soft_iron_2-val ((m <SetSoftIronMatrix-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader microstrain_mips-srv:soft_iron_2-val is deprecated.  Use microstrain_mips-srv:soft_iron_2 instead.")
  (soft_iron_2 m))

(cl:ensure-generic-function 'soft_iron_3-val :lambda-list '(m))
(cl:defmethod soft_iron_3-val ((m <SetSoftIronMatrix-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader microstrain_mips-srv:soft_iron_3-val is deprecated.  Use microstrain_mips-srv:soft_iron_3 instead.")
  (soft_iron_3 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetSoftIronMatrix-request>)))
  ...
  "microstrain_mips/SetSoftIronMatrixRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetSoftIronMatrix-request)))
  "Returns string type for a service object of type 'SetSoftIronMatrix-request"
  "microstrain_mips/SetSoftIronMatrixRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetSoftIronMatrix-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetSoftIronMatrix-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name microstrain_mips-srv:<SetSoftIronMatrix-response> is deprecated: use microstrain_mips-srv:SetSoftIronMatrix-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetSoftIronMatrix-response>)))
  ...
  "microstrain_mips/SetSoftIronMatrixResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetSoftIronMatrix-response)))
  "Returns string type for a service object of type 'SetSoftIronMatrix-response"
  "microstrain_mips/SetSoftIronMatrixResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetSoftIronMatrix)))
  ...
  "microstrain_mips/SetSoftIronMatrix")