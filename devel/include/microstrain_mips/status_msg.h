// Generated by gencpp from file microstrain_mips/status_msg.msg
// DO NOT EDIT!


#ifndef MICROSTRAIN_MIPS_MESSAGE_STATUS_MSG_H
#define MICROSTRAIN_MIPS_MESSAGE_STATUS_MSG_H
...
struct status_msg_
{
  ...
  typedef boost::shared_ptr< ::microstrain_mips::status_msg_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::microstrain_mips::status_msg_<ContainerAllocator> const> ConstPtr;

}; // struct status_msg_

typedef ::microstrain_mips::status_msg_<std::allocator<void> > status_msg;

typedef boost::shared_ptr< ::microstrain_mips::status_msg > status_msgPtr;
typedef boost::shared_ptr< ::microstrain_mips::status_msg const> status_msgConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::microstrain_mips::status_msg_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::microstrain_mips::status_msg_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::microstrain_mips::status_msg_<ContainerAllocator1> & lhs, const ::microstrain_mips::status_msg_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::microstrain_mips::status_msg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::microstrain_mips::status_msg_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::microstrain_mips::status_msg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::microstrain_mips::status_msg_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::microstrain_mips::status_msg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::microstrain_mips::status_msg_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::microstrain_mips::status_msg_<ContainerAllocator> >
{
  ...
  static const char* value(const ::microstrain_mips::status_msg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xb19b8bec6f96c609ULL;
  static const uint64_t static_value2 = 0x664c27dbc51ddf60ULL;
};

template<class ContainerAllocator>
struct DataType< ::microstrain_mips::status_msg_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::microstrain_mips::status_msg_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::microstrain_mips::status_msg_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::microstrain_mips::status_msg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::microstrain_mips::status_msg_<ContainerAllocator>& v)
  {
...
#endif // MICROSTRAIN_MIPS_MESSAGE_STATUS_MSG_H
