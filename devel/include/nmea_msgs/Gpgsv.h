...
struct Gpgsv_
{
  ...
  _n_satellites_type n_satellites;
   ...
   typedef std::vector< ::nmea_msgs::GpgsvSatellite_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::nmea_msgs::GpgsvSatellite_<ContainerAllocator> >> _satellites_type;
...
bool operator==(const ::nmea_msgs::Gpgsv_<ContainerAllocator1> & lhs, const ::nmea_msgs::Gpgsv_<ContainerAllocator2> & rhs)
{
