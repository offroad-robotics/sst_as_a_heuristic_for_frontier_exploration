...
"""autogenerated by genpy from spot_msgs/MaplessTrajectoryAction.msg. Do not edit."""
import codecs
import sys
...
class MaplessTrajectoryAction(genpy.Message):
  _md5sum = "e23bfaf5402793b0691e27f86456571f"
  _type = "spot_msgs/MaplessTrajectoryAction"
...
"""
  ...
  _slot_types = ['spot_msgs/MaplessTrajectoryActionGoal','spot_msgs/MaplessTrajectoryActionResult','spot_msgs/MaplessTrajectoryActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MaplessTrajectoryAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = spot_msgs.msg.MaplessTrajectoryActionGoal()
      if self.action_result is None:
        self.action_result = spot_msgs.msg.MaplessTrajectoryActionResult()
      if self.action_feedback is None:
        self.action_feedback = spot_msgs.msg.MaplessTrajectoryActionFeedback()
    else:
      self.action_goal = spot_msgs.msg.MaplessTrajectoryActionGoal()
      self.action_result = spot_msgs.msg.MaplessTrajectoryActionResult()
      self.action_feedback = spot_msgs.msg.MaplessTrajectoryActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_i3I().pack(_x.action_result.result.attempts, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_7d().pack(_x.action_feedback.feedback.error.position.x, _x.action_feedback.feedback.error.position.y, _x.action_feedback.feedback.error.position.z, _x.action_feedback.feedback.error.orientation.x, _x.action_feedback.feedback.error.orientation.y, _x.action_feedback.feedback.error.orientation.z, _x.action_feedback.feedback.error.orientation.w))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_feedback.feedback.current_attempt
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_result.result.attempts, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _get_struct_i3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_feedback.feedback.error.position.x, _x.action_feedback.feedback.error.position.y, _x.action_feedback.feedback.error.position.z, _x.action_feedback.feedback.error.orientation.x, _x.action_feedback.feedback.error.orientation.y, _x.action_feedback.feedback.error.orientation.z, _x.action_feedback.feedback.error.orientation.w,) = _get_struct_7d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.current_attempt,) = _get_struct_i().unpack(str[start:end])
      return self
