...
"""autogenerated by genpy from spot_msgs/MaplessTrajectoryActionResult.msg. Do not edit."""
import codecs
import sys
...
class MaplessTrajectoryActionResult(genpy.Message):
  _md5sum = "e014053e365e3b2416b2bd5edde5a89f"
  _type = "spot_msgs/MaplessTrajectoryActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','spot_msgs/MaplessTrajectoryResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MaplessTrajectoryActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = spot_msgs.msg.MaplessTrajectoryResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = spot_msgs.msg.MaplessTrajectoryResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.attempts,) = _get_struct_i().unpack(str[start:end])
      return self
