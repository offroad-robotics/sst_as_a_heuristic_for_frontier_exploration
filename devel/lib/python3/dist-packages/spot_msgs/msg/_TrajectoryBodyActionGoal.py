...
"""autogenerated by genpy from spot_msgs/TrajectoryBodyActionGoal.msg. Do not edit."""
import codecs
import sys
...
class TrajectoryBodyActionGoal(genpy.Message):
  _md5sum = "6a8331f7d10a65ec221ecacfd44669ef"
  _type = "spot_msgs/TrajectoryBodyActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','spot_msgs/TrajectoryBodyGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TrajectoryBodyActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = spot_msgs.msg.TrajectoryBodyGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = spot_msgs.msg.TrajectoryBodyGoal()
