...
"""autogenerated by genpy from spot_msgs/TrajectoryActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class TrajectoryActionFeedback(genpy.Message):
  _md5sum = "99eff65d7d7ea548572edff08e1d4324"
  _type = "spot_msgs/TrajectoryActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','spot_msgs/TrajectoryFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TrajectoryActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = spot_msgs.msg.TrajectoryFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = spot_msgs.msg.TrajectoryFeedback()
