...
"""autogenerated by genpy from spot_msgs/TrajectoryActionResult.msg. Do not edit."""
import codecs
import sys
...
class TrajectoryActionResult(genpy.Message):
  _md5sum = "1471476fb0fc7d1ce25819ffcafc3f6d"
  _type = "spot_msgs/TrajectoryActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','spot_msgs/TrajectoryResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TrajectoryActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = spot_msgs.msg.TrajectoryResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = spot_msgs.msg.TrajectoryResult()
