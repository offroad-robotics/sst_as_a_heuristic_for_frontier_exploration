...
"""autogenerated by genpy from spot_msgs/TrajectoryBodyActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class TrajectoryBodyActionFeedback(genpy.Message):
  _md5sum = "99eff65d7d7ea548572edff08e1d4324"
  _type = "spot_msgs/TrajectoryBodyActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','spot_msgs/TrajectoryBodyFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TrajectoryBodyActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = spot_msgs.msg.TrajectoryBodyFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = spot_msgs.msg.TrajectoryBodyFeedback()
