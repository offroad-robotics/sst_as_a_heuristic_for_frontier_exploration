...
"""autogenerated by genpy from spot_msgs/AprilTagState.msg. Do not edit."""
import codecs
import sys
...
class AprilTagState(genpy.Message):
  _md5sum = "6fcb386a7599f04b7e66974f6e2d0758"
  _type = "spot_msgs/AprilTagState"
...
string frame_id
"""
  __slots__ = ['header','ids','tag_ids','names']
  _slot_types = ['std_msgs/Header','int32[]','int32[]','string[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AprilTagState, self).__init__(*args, **kwds)
