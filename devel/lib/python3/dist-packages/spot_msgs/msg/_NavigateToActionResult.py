...
"""autogenerated by genpy from spot_msgs/NavigateToActionResult.msg. Do not edit."""
import codecs
import sys
...
class NavigateToActionResult(genpy.Message):
  ...
  _type = "spot_msgs/NavigateToActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','spot_msgs/NavigateToResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = spot_msgs.msg.NavigateToResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = spot_msgs.msg.NavigateToResult()
