...
"""autogenerated by genpy from spot_msgs/NavigateToAction.msg. Do not edit."""
import codecs
import sys
...
class NavigateToAction(genpy.Message):
  _md5sum = "edd2689a7c16d32f5c915bf66e2d77e5"
  _type = "spot_msgs/NavigateToAction"
...
"""
  ...
  _slot_types = ['spot_msgs/NavigateToActionGoal','spot_msgs/NavigateToActionResult','spot_msgs/NavigateToActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = spot_msgs.msg.NavigateToActionGoal()
      if self.action_result is None:
        self.action_result = spot_msgs.msg.NavigateToActionResult()
      if self.action_feedback is None:
        self.action_feedback = spot_msgs.msg.NavigateToActionFeedback()
    else:
      self.action_goal = spot_msgs.msg.NavigateToActionGoal()
      self.action_result = spot_msgs.msg.NavigateToActionResult()
      self.action_feedback = spot_msgs.msg.NavigateToActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_goal.goal.upload_path
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_goal.goal.navigate_to
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_goal.goal.initial_localization_fiducial
      buff.write(_get_struct_B().pack(_x))
      _x = self.action_goal.goal.initial_localization_waypoint
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_feedback.feedback.waypoint_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.upload_path = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.upload_path = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.navigate_to = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.navigate_to = str[start:end]
      start = end
      end += 1
      (self.action_goal.goal.initial_localization_fiducial,) = _get_struct_B().unpack(str[start:end])
      self.action_goal.goal.initial_localization_fiducial = bool(self.action_goal.goal.initial_localization_fiducial)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.initial_localization_waypoint = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.initial_localization_waypoint = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.action_feedback.feedback.waypoint_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_feedback.feedback.waypoint_id = str[start:end]
      return self
